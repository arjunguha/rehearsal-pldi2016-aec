# NOTE(arjun):
#
# Source: https://github.com/ghoneycutt/puppet-xinetd/tree/a893f4a16e247b219bf6a9703ded863c67b98985
#
# This is the head of the repository and it has a determinism bug.
...
define xinetd::service (
  ...
  # TODO(arjun): This is dead code and we can't parse it.
#  if $wait {
#    $mywait = $wait
#  } else {
#    $mywait = $protocol ? {
