# NOTE(arjun):
#
# Concatenates all Puppet files from:
#
# https://github.com/vpetersson/puppet-hosting/tree/78a63036a3cb64dc769e2b757013adeb9f340b6f

# NOTE(arjun): Need to instantiate the class.
include hosting
include hosting::mysql

# TODO(arjun): hosting::php requires arrays of resource titles
